...
class CustomEvaluation():
    def __init__(self,mapping_e,mapping_p,max_e,max_p,batch_size):
        self.accuracy_path="/home/ubuntu/data/home/ubuntu/deeplogic/metrics/rl/validation/accuracy.csv"
        self.tp_path="/home/ubuntu/data/home/ubuntu/deeplogic/metrics/rl/validation/tp.csv"
        self.tn_path="/home/ubuntu/data/home/ubuntu/deeplogic/metrics/rl/validation/tn.csv"
        self.fp_path="/home/ubuntu/data/home/ubuntu/deeplogic/metrics/rl/validation/fp.csv"
        self.fn_path="/home/ubuntu/data/home/ubuntu/deeplogic/metrics/rl/validation/fn.csv"
        self.loss_path="/home/ubuntu/data/home/ubuntu/deeplogic/metrics/rl/validation/loss.csv"
        self.recall_path="/home/ubuntu/data/home/ubuntu/deeplogic/metrics/rl/validation/recall.csv"
        self.precision_path="/home/ubuntu/data/home/ubuntu/deeplogic/metrics/rl/validation/precision.csv"
        self.soundness_path="/home/ubuntu/data/home/ubuntu/deeplogic/metrics/rl/validation/soundness.csv"
        self.quality_path="/home/ubuntu/data/home/ubuntu/deeplogic/metrics/rl/validation/quality.csv"
        self.f1_path="/home/ubuntu/data/home/ubuntu/deeplogic/metrics/rl/validation/f1.csv"
        self.absolute_path="/home/ubuntu/data/home/ubuntu/deeplogic/metrics/rl/validation/"
...
def get_dataset(i,mapping_entities,mapping_properties,max_e,max_p,onlyfiles):
    ...
    for j in range(i*100,(i+1)*100): 
        ...
        g1 = Graph()
        g1.bind("ex",n)
        g1.parse("/home/ubuntu/data/home/ubuntu/deeplogic/train_pre/scene{}.ttl".format(onlyfiles[j]), format="turtle")
        ...
        g2 = Graph()
        g2.bind("ex",n)
        g2.parse("/home/ubuntu/data/home/ubuntu/deeplogic/src/main/resources/dataset/dataset/train_materialized/rl/scene{}.ttl".format(onlyfiles[j]),format="turtle")
...
def train_model(options,num_e,num_p):
    ...
    with open("/home/ubuntu/data/home/ubuntu/deeplogic/used_rl.csv",'w') as fd:
            fd.write(str(onlyfiles))
    ...
    try: 
        ...
        print("modello fatto",flush=True)
        lr = 0.09
        ...
        for epoch in range(EPOCHS):
            ...
            model.train()
            for i in range(35):
                train_loader,X_train_shape= get_dataset(i,mapping_entities,mapping_properties,max_e,max_p,onlyfiles)
            ...
            with torch.no_grad():
                for i in range(35,50):
                    valid_loader,X_valid_shape= get_dataset(i,mapping_entities,mapping_properties,max_e,max_p,onlyfiles)
            ...
            torch.save({
                ...
                'loss': loss,
                }, '/home/ubuntu/data/home/ubuntu/deeplogic/rl_model_params/epochs'+str(epoch))
...
if __name__ == "__main__":
    ...
    """
    {
        ...
        'stride_pool_layer1': 1, 
        'kernel_size_layer2': 9, 
        'n_filter_layer2': 2, 
        'stride_pool_layer2': 1, 
        'kernel_size_layer3': 15, 
        'n_filter_layer3': 3, 
        'stride_pool_layer3': 1, 
        'kernel_size_layer4': 13, 
        'n_filter_layer4': 3, 
        'stride_pool_layer4': 2, 
        'kernel_size_layer5': 3, 
        'n_filter_layer5': 6
        }
    """
    options=[[5,1,1],[9,2,1],[15,3,1],[13,3,2],[3,6,1]]
    train_model(options,386,16)

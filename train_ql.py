...
class CustomEvaluation():
    def __init__(self,mapping_e,mapping_p,max_e,max_p,batch_size):
        self.accuracy_path="/home/ubuntu/data/home/ubuntu/deeplogic/metrics/ql/validation/accuracy.csv"
        self.tp_path="/home/ubuntu/data/home/ubuntu/deeplogic/metrics/ql/validation/tp.csv"
        self.tn_path="/home/ubuntu/data/home/ubuntu/deeplogic/metrics/ql/validation/tn.csv"
        self.fp_path="/home/ubuntu/data/home/ubuntu/deeplogic/metrics/ql/validation/fp.csv"
        self.fn_path="/home/ubuntu/data/home/ubuntu/deeplogic/metrics/ql/validation/fn.csv"
        self.loss_path="/home/ubuntu/data/home/ubuntu/deeplogic/metrics/ql/validation/loss.csv"
        self.recall_path="/home/ubuntu/data/home/ubuntu/deeplogic/metrics/ql/validation/recall.csv"
        self.precision_path="/home/ubuntu/data/home/ubuntu/deeplogic/metrics/ql/validation/precision.csv"
        self.soundness_path="/home/ubuntu/data/home/ubuntu/deeplogic/metrics/ql/validation/soundness.csv"
        self.quality_path="/home/ubuntu/data/home/ubuntu/deeplogic/metrics/ql/validation/quality.csv"
        self.f1_path="/home/ubuntu/data/home/ubuntu/deeplogic/metrics/ql/validation/f1.csv"
        self.absolute_path="/home/ubuntu/data/home/ubuntu/deeplogic/metrics/ql/validation/"
    ...
    def update(self,y_pred_batch,y_true_batch):
        ...
        for i in range(self.batch_size):
            ...
            print(y_true_batch.size(),flush=True)
            print(y_pred_batch.size(),flush=True)
            y_true = y_true_batch[0][i]
            y_pred = y_pred_batch[0][i]
            print("arrivo qui",flush=True) 
            tn,fp,fn,tp = 0,0,0,0
    ...
    try: 
        ...
        for epoch in range(EPOCHS):
            ...
            with torch.no_grad():
                for i in range(100,140):
                    ...
                    for batch_idx, (data, target) in enumerate(valid_loader):
                        ...
                        print("risultati",flush=True)
                        print(pred.size(),flush=True)
                        print(pred,flush=True)
                        print(target.size(),flush=True)
                        print(target,flush=True)
                        evaluation.update(pred,target)
                        print("update eval",flush=True)
                    del valid_loader
                    gc.collect()
            ...
            torch.save({
                ...
                'loss': loss,
                }, '/home/ubuntu/data/home/ubuntu/deeplogic/ql_model_params/epochs'+str(epoch))
        print("ACCURACY: " +str(accuracy),flush=True)
        with open('/home/ubuntu/data/home/ubuntu/deeplogic/ql_model_params/mapping_e.json', 'w') as outfile:
            json.dump(mapping_entities, outfile)
        with open('/home/ubuntu/data/home/ubuntu/deeplogic/ql_model_params/mapping_p.json', 'w') as outfile:
